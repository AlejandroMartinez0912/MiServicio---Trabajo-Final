...
<div class="d-flex justify-content-center align-items-center vh-100">
    <div class="card p-4 shadow-lg" style="width: 28rem;">
        <h2 class="text-center mb-4">Únete a <span class="text-primary">MiServicio</span></h2>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('validar-registro') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="emailInput" name="email" value="{{ old('email') }}" required autocomplete="disable" placeholder="Ingresa tu correo">
                </div>
