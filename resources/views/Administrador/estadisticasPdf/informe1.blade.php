...
<head>
    ...
    <title>MiServicio | Informe de Servicios por Rubros</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><strong>MiServicio</strong> | Informe de Servicios por Rubros</h1>
        ...
        <div class="content">
            ...
            <table border="1">
                ...
                <tbody>
                    @foreach($serviciosPorRubro as $rubro)
                        <tr>
                            <td>{{ $rubro->rubro }}</td>
                            <td>{{ $rubro->total_reservas }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
